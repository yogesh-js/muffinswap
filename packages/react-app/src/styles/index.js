const styles = {
  // App.js
  container: "flex justify-center min-h-screen sm:px-16 px-6 bg-teal-900",
  innerContainer:
  ...
  exchange:
    "w-full min-h-[400px] bg-teal-900 backdrop-blur-[4px] rounded-3xl shadow-card flex p-10",
  ...
  // WalletButton
  walletButton:
    "bg-pink-800 border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-pink-600 transition-all",
